...
class FollowerViewModelTest {
    ...
    fun setUp() {
        ...
        viewModel = FollowerViewModel(userUseCase)
    }
    ...
    @Test
    fun `getListFollower success should set state to UserData`() = runTest {
        ...
        Assert.assertTrue(result is FollowerState.UserData)
        Assert.assertEquals(expected, (result as FollowerState.UserData).pagingData)
    }
